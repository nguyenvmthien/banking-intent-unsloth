...
def main():
    ...
    train_df[['text', 'label', 'intent_name']].to_csv('../sample_data/train.csv', index=False)
    test_df[['text', 'label', 'intent_name']].to_csv('../sample_data/test.csv', index=False)

    print("Saved to ../sample_data/train.csv and ../sample_data/test.csv")
